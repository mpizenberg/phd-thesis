...
Baker and Matthews, Inverse / forward compositional, pas parler de forward additive, Gauss-Newton.

\subsection{Extensions and Richer Modelizations}%
\label{sub:vo_extensions}

robust
Extensions to rolling shutter, continuous-time location, other cameras, photometric changes, etc.

deep learning, event cameras, ...
