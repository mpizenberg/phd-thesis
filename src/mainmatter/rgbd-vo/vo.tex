...
In the previous formulation, we eluded writing the actual expression of the warp function
...
some authors use deep neural networks to estimate depth information
...
materials and orientation, and on the lighting conditions.
...
In our work led by Y. Quéau~\cite{queau2017microgeometry},
...
Another incorrect assumption is that an image has been taken at a fixed camera position.
...
One can take advantage of rolling shutter for artistic effects
such as in Figure~\ref{fig:rolling_shutter_prop}.
When tracking high speed camera motions however the bending of straight
