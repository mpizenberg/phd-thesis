...
\comment{}{Intro de chapitre avec contexte et annonce de plan.}
...
\comment{most people just click ``agree'' and move on.}{justify}
...
\comment{}{I'll make the assumption that you got the NaCl and pepper joke \ldots}
...
\replace{To target WebAssembly, every dependency recursively, must be recompiled
...
\remove{I tried to build a minimalist OpenCV program with Emscripten
