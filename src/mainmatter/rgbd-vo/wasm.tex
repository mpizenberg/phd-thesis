...
The Unreal game engine was ported, Autodesk AutoCAD, Adobe Lightroom,
Facebook image compressions uploading code, OpenCV and many others.
...
Figure~\ref{fig:wasm-timeline} summarizes major events leading to the creation of WebAssembly.
