Computer vision is a computational science aiming at reproducing and improving
the ability of human vision to understand its environment from light sensors.
Throughout this document, I want to bring you on a somewhat unconventional,
multidisciplinary journey, mixing computer vision,
user interactions, and the most ubiquitous of all platforms, the Web.
My goal is to illustrate how different fields of computer vision,
such as image annotation and segmentation or visual odometry,
can take advantage of human interactions and
recent improvement of Web technologies
to both improve and better share our research.
