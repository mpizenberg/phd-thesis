...
and of a thread pool, executing all blocking I/O calls like file read.
...
\lstinputlisting[language=JavaScript,caption={Read a file.},label={lst:read-file-js}]{assets/code/readFile.js}
